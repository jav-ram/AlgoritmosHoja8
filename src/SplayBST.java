 ...
 * @param <T>
 */
public class SplayBST<T extends Comparable<T>> implements Iterable<T> {
	 ...
	 * @return
	 */
	public static <T extends Comparable<T>> SplayBST<T> create() {
		return new SplayBST<T>();
	}
	 ...
	 * @return
	 */
	public static <T extends Comparable<T>> SplayBST<T> create(T... elements) {
		SplayBST<T> tree = new SplayBST<T>();
